...
const Banner = ({bannerText,isHE}) =>{
    return (
        ...
        <Content className="content" style={{background:'#000000'}}>
            ...
            <a style={{color:'linear-gradient(180deg, #5C677D 0%, #7D8597 48%, #979DAC 100%)'}} href="#main" class="button scrolly">{isHE ? 'לחץ כאן' : 'CLICK HERE'}</a>
        </Content>
    </Section>
    )
}
